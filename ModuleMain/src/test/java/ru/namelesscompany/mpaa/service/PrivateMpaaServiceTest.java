...
import ru.namelesscompany.mpaa.service.privateService.PrivateMpaaServiceImpl;
...
public class PrivateMpaaServiceTest {
    private PrivateMpaaServiceImpl mpaaService;
    ...
    public void setUp() {
        ...
        mpaaService = new PrivateMpaaServiceImpl(mpaaRepository);
