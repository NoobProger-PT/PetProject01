...
@WebMvcTest(controllers = FilmPublicController.class)
public class FilmPublicControllerTest {
    @Autowired
    private MockMvc mockMvc;
    @Autowired
    ObjectMapper mapper;
    @MockBean
    private PublicFilmService filmService;
    ...
    public void shouldGetById() throws Exception {
        ...
        mockMvc.perform(get("/public/films/1")
    ...
    public void shouldGetByName() throws Exception {
        ...
        mockMvc.perform(get("/public/films/search?name=fIlM")
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
