package ru.namelesscompany.users.repository;
...
public class UserRepositoryTest {
    ...
    public void shouldGetByIds() {
        ...
        assertThat(2, equalTo(userRepository.findAll().size()));
    }
    ...
    public void shouldUpdate() {
        ...
        updatedUser.setRegistrationDate(LocalDate.of(2022,9,7));
        User upUser = userRepository.save(updatedUser);
        assertThat(updatedUser.getName(), equalTo(upUser.getName()));
    }
