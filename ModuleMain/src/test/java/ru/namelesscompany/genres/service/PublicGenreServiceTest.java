...
import ru.namelesscompany.genre.service.publicService.PublicGenreServiceImpl;
...
public class PublicGenreServiceTest {
    private PublicGenreServiceImpl genreService;
    ...
    public void setUp() {
        ...
        genreService = new PublicGenreServiceImpl(genreRepository);
